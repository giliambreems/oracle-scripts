...
--  sc_endpoint_base             constant varchar2(128) default 'http://127.0.0.1:85/edsn/synchroon';  -- channel voor producten werkt nog niet
...
--    pkg_utl_log.add_system('PKG_UTL_SOAP.SOAPRequest(p_endpoint => {0}, p_header_soapaction => {1}, p_request_data => {2})', p_endpoint, p_header_soapaction, DBMS_LOB.SUBSTR(p_request_data, 2048, 1));
    ...
    begin
      ...
      DBMS_OUTPUT.PUT_LINE('HTTP response version: ' || l_http_resp.http_version);
      dbms_output.put_line('');
...
<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/">
	...
	<soapenv:Body>
		<urn:SearchMeteringPointsRequestEnvelope xmlns:urn="urn:nedu:edsn:data:searchmeteringpointsrequest:1:standard">
			<urn:EDSNBusinessDocumentHeader>
				<urn:CreationTimestamp>2024-07-08T11:48:24</urn:CreationTimestamp>
				<urn:MessageID>09a3efc6-c90c-4516-91f3-2ac136d688d4</urn:MessageID>
				<urn:Destination>
					<urn:Receiver>
						<urn:Authority>EAN.UCC</urn:Authority>
						<urn:ContactTypeIdentifier>EDSN</urn:ContactTypeIdentifier>
				...
				<urn:Source>
					<urn:Authority>EAN.UCC</urn:Authority>
					<urn:ContactTypeIdentifier>DDQ_O</urn:ContactTypeIdentifier>
					<urn:SenderID>8712423034372</urn:SenderID>
				</urn:Source>
			</urn:EDSNBusinessDocumentHeader>
			<urn:Portaal_Content>
				<urn:Portaal_MeteringPoint>
          <urn:EDSN_AddressSearch>
            <urn:BuildingNr>5</urn:BuildingNr>
            <!-- <urn:ExBuildingNr>#HUISNUMMER_TOEV#</urn:ExBuildingNr> -->
            <urn:ZIPCode>2807 LP</urn:ZIPCode>
          </urn:EDSN_AddressSearch>
