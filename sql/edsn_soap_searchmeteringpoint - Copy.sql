...
--  sc_ean_lv                    constant varchar2(18)  default fg_service.pkg_utl_instelling.instelling( 'EAN_EIGEN_LV' );  -- 8712423034372 voor GCP
  ...
  sc_edsn_searchmeteringpoints constant varchar2(128) default '/ResponderMasterDataRespondingActivity';
  sc_endpoint                  constant varchar2(256) default sc_endpoint_base || sc_edsn_searchmeteringpoints;

  sc_soap_action               constant varchar2(128) default 'MasterData';
...
<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/"
   xmlns:urn="urn:nedu:edsn:data:masterdatarequest:1:standard">
   <soapenv:Header/>
   <soapenv:Body>
      <urn:MasterDataRequestEnvelope>
         ...
         <urn:Portaal_Content>
            <urn:Portaal_MeteringPoint>
               ...
               <urn:GridOperator_Company>
                  <urn:ID>0001112223334</urn:ID>
               </urn:GridOperator_Company>
               <urn:Portaal_Mutation>
                  <urn:Portaal_UserInformation>
                     <urn:Organisation>#EAN_LV#</urn:Organisation>
                  </urn:Portaal_UserInformation>
               </urn:Portaal_Mutation>
            </urn:Portaal_MeteringPoint>
         </urn:Portaal_Content>
...
--  cl_request_data := replace_or_comment_out( cl_request_data, '#ADDRESS#'        , 5 || null || null || null );  -- all address fields empty (or not)
  ...
  -- OF EAN vullen
  cl_request_data := replace_or_comment_out( cl_request_data, '#EANID#'            , '871685900001854828' );  -- pi_ean  -- '111242300000110578'
